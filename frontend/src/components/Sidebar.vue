  ...
  <aside class="sidebar">
    <div class="sidebar-header">
      <div class="logo-icon" aria-hidden="true">
        <img src="/lumina.png" alt="" class="logo-image">
      </div>
    ...
    <div class="workspace-switcher">
      <span class="workspace-orb" aria-hidden="true">
        <img src="/lumina.png" alt="" class="orb-image">
      </span>
      <span class="workspace-copy">
        <strong>LuminaRAG 知识空间</strong>
...
const userInitials = computed(() => {
  const name = authStore.currentUser?.username?.trim() || 'U';
  // 中文用户名取第一个汉字；英文取单词首字母（最多两个）
