  ...
  <section class="auth-page">
    <div class="auth-showcase">
      <div class="auth-showcase-badge">
        ...
        <span>LuminaRAG Knowledge Copilot</span>
      </div>
    ...
    <div class="auth-panel">
      <div class="auth-panel-heading">
        <span class="auth-mini-logo"><img src="/lumina.png" alt="" class="logo-image"></span>
        <div>
          <span class="auth-eyebrow">{{ authStore.authMode === 'login' ? 'Welcome back' : 'Create account' }}</span>
          <h1>{{ authStore.authMode === 'login' ? '登录lumina助手' : '注册lumina助手' }}</h1>
        </div>
      </div>
